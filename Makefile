...
board_test_debug: stack_board.cpp board.cpp utils.cpp
	$(GPP) $(DEBUG) -DBOARD_TEST -o board_test_debug board.cpp 

board_test_opt:   stack_board.cpp board.cpp utils.cpp
	$(GPP) $(OPT)   -DBOARD_TEST -o board_test_opt   board.cpp 

board_test_prof:  stack_board.cpp board.cpp utils.cpp
	$(GPP) $(PROF)  -DBOARD_TEST -o board_test_prof  board.cpp 



playout_test_debug: stack_board.cpp board.cpp utils.cpp playout.cpp
	$(GPP) $(DEBUG) -DPLAYOUT_TEST -o playout_test_debug playout.cpp 

playout_test_opt:   stack_board.cpp board.cpp utils.cpp playout.cpp
	$(GPP) $(OPT)   -DPLAYOUT_TEST -o playout_test_opt   playout.cpp 

playout_test_prof:  stack_board.cpp board.cpp utils.cpp playout.cpp
	$(GPP) $(PROF)  -DPLAYOUT_TEST -o playout_test_prof   playout.cpp 



engine_debug: board.cpp stack_board.cpp utils.cpp playout.cpp gtp.cpp gtp.h gtp_board.cpp main.cpp
	$(GPP) $(DEBUG) -o engine_debug gtp.cpp main.cpp

engine_opt:   board.cpp stack_board.cpp utils.cpp playout.cpp gtp.cpp gtp.h gtp_board.cpp main.cpp
	$(GPP) $(OPT)   -o engine_opt   gtp.cpp main.cpp

engine_prof:  board.cpp stack_board.cpp utils.cpp playout.cpp gtp.cpp gtp.h gtp_board.cpp main.cpp
